...
import com.example.zuoyeend.bean.UserInfo;
import com.example.zuoyeend.database.UserDBHelper;
import com.example.zuoyeend.util.DateUtil;
import com.example.zuoyeend.util.ViewUtil;
...
public class LoadActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990012 董滨珲"};
